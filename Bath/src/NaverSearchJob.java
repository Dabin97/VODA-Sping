...
public class NaverSearchJob implements Job {
	private static final String CLIENT_ID = "d_K2aUUD31ZJcYD5Wff1";//애플리케이션 클라이언트 아이디값";
    private static final String CLIENT_SECRET = "Ge3aFPyZdM";//애플리케이션 클라이언트 시크릿값";
	private static final String API_URL = "https://openapi.naver.com/v1/search/news?query=";
